...
//		}
	...
	void GUIHelp ()
	{
		GUILayout.Label ("Jelly Garden Match 3 Complete Project + EDITOR v 1.6.2", EditorStyles.boldLabel, new GUILayoutOption[] { GUILayout.Width (400) });
...
//		lm.FacebookEnable = EditorGUILayout.Toggle ("Enable Facebook", lm.FacebookEnable, new GUILayoutOption[] {//1.6.1
//			GUILayout.Width (50),
//			GUILayout.MaxWidth (200)
//		});
		if (GUILayout.Button ("Install", new GUILayoutOption[] { GUILayout.Width (100) })) {
